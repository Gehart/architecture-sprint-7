...
| 4   | Реализован ли принцип минимальных привилегий при назначении ролей и прав доступа?                                                        |   нет | Доступ к данным основан на бизнес процессах и не регулируется с нужной тщательностью             |
...
| 9   | Созданы ли замкнутые контуры для подсистем, работающих с чувствительными данными?                                                        | да и нет   |   Есть контур для финансовых данных и данных аналитики           |
| 10  | Ограничен ли доступ к системам из внешних источников?                                                                                    |   нет   | внешние партнеры могут выполнять слишком много действия             |
| 11  | Ведётся ли единый реестр учётных записей?                                                                                               |   нет    |   есть несколько систем авторизациии           |
| 12  | Используются ли средства управления учётными записями на базе единого реестра?                                                          |   нет    |  есть несколько систем авторизациии           |            |
...
| 1   | Разработана ли политика классификации данных, и актуализируется ли она в соответствии с действующим законодательством?                  |  нет    | на данный момент в разработке             |
...
| 4   | Проводится ли регулярное резервное копирование данных? Хранятся ли резервные копии в защищённых хранилищах?                             | да     |  Резервное копирование производится            |
...
| 7   | Ведётся ли учёт персональных данных, и применяются ли специальные процедуры обработки и хранения для различных типов данных?            |   да    | данные хранятся в отдельных бд             |
...
| 14  | Разработана ли инструкция по процессу восстановления данных?                                                                            |    да   |       есть бэкап       |
| **III. Защита инфраструктуры**                                                                                                                 |       |              |
| 1   | Используется ли межсетевой экран для ограничения входящего и исходящего трафика?                                                        |    да   | firewall присутствует на схеме             |
